...
namespace MemExchange.Server.Incoming
{
    public class IncomingMessageQueue : IIncomingMessageQueue
    {
        ...
        public void Start()
        {
            messageDisrupter = new Disruptor<RingbufferByteArray>(() => new RingbufferByteArray(), ringbufferSize, TaskScheduler.Default, ProducerType.Single, new SleepingWaitStrategy());
