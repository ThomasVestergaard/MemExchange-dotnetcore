...
namespace MemExchange.Client.UI.Setup
{
    public class DependencyInjection
    {
        ...
        public void Initialize(IConfiguration configuration)
        {
            ...
            Container.Register(Component.For<ILogger>().ImplementedBy<DummyLogger>());
            Container.Register(Component.For<ISerializer>().ImplementedBy<ProtobufSerializer>());
            Container.Register(Component.For<IMessageConnection>().ImplementedBy<MessageNatsConnection>().LifestyleSingleton());
